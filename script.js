...
addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelector('input#num-of-balls').addEventListener('mouseup', handleNumber);
  
  document.querySelector('input#size-of-balls').addEventListener('mouseup', handleSize);
  
  document.querySelector('input#speed-of-balls').addEventListener('mouseup', handleSpeed);
  
  document.querySelector('input#trails').addEventListener('mouseup', handleTrails);
